...
env.d/development_xapi:
	cp env.d/development_xapi.dist env.d/development_xapi

.PHONY: bootstrap
bootstrap: env.d/development env.d/development_xapi ## Prepare Docker images for the project
	@$(COMPOSE) build base;
	@$(COMPOSE) build app;
